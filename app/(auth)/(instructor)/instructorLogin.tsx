  ...
  const handleSignin = async () => {
    ...
    try {
      ...
      if (response.ok || response.status === 200) {
        ...
        if (decode.user_type === "Instructor") {
          setAuthTokens(data);
          setUser(decode);
          // await AsyncStorage.setItem("isParent", JSON.stringify(false));
          ...
          alert("User Is Not An Instructor");
        }
      } else {
        alert(data.detail);
        console.log(data);
        ...
        >
          <View style={{ flexDirection: "column", gap: 20 }}>
            ...
            >
              ...
              <Link
                href={"/(auth)/(instructor)/(forget)/instructorForgetPassword"}
                asChild
              >
                <TouchableOpacity>
                  <Text
          ...
          >
            ...
            >
              ...
              <Link
                href={"/(auth)/(instructor)/instructorRegister"}
